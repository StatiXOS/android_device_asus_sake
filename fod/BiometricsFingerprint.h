...
#include <vendor/asus/fingerprint/extension/1.0/IVendorFingerprintExtensions.h>
#include <vendor/asus/hardware/display/1.0/IAsusDisplay.h>
...
using ::android::sp;
using ::vendor::asus::fingerprint::extension::V1_0::IVendorFingerprintExtensions;
using ::vendor::asus::hardware::display::V1_0::IAsusDisplay;
...
private:
    ...
    sp<IAsusDisplay> mVendorDisplayService;
